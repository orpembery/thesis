...
\begin{longtabu}{ccc}
  ...
  $\CRecofn{????}$&&\\
  $\Ctildemin$&&\\
  $\Chcond$ & $\frac1{\mleft(4\Csecond \CRecofn{????}^{p-1}\mright)^{2p}} \min\set{\frac1{\CFEMttilde^{\frac1{2p}}},\frac{\Ctildemin^{\frac1{2p}}}{\CFEMotilde^{\frac1{p+1}}}}$ & \cref{thm:fembound}\\
  ...
  $\CLtboundo$&$\mleft(\Cfirst+ \Csecond \mleft(\sum_{j=0}^{p-1} \CRecofn{????}^j \CRect^j\mright)\mright) \CFEMotilde$&Proof of \cref{thm:fembound}\\
  $\CLtboundt$&$\mleft(\Cfirst+ \Csecond \mleft(\sum_{j=0}^{p-1} \CRecofn{????}^j \CRect^j\mright)\mright)\CFEMttilde$&Proof of \cref{thm:fembound}\\

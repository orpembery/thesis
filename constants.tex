...
& \cref{lem:shiftnegativew}\\
  ...
  $\CcorLt$&$4\max\set{\CFEMo,\CFEMt}\mleft(\Cmmofn{0} + \Cmmofn{-1}\mright) \max\set{\CLtboundo,\CLtboundt}$&\Cref{thm:fembound}\\
  $\CcorHo$&$8\max\set{\CFEMo,\CFEMt}\mleft(\Cmmofn{0} + \Cmmofn{-1}\mright)\max\set{\CHoboundo+\CLtboundo,\CHoboundt+\CLtboundt}$&\Cref{thm:fembound}\\

In this \lcnamecref{app:hhqmcconv} we provide plots showing the dependence of the QMC error $\QMCerror{\NQMC}{\Nshifts}$ on $\NQMC$ for \emph{fixed} values of $k$ and increasing $\NQMC$. Aside from the fact that we vary $\NQMC$, our computational setup is as in \cref{sec:nbpcqmcnumerics}.

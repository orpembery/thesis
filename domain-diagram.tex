...
\filldraw[color=white,scale=\domainscale] % The obstacle
\obstacle
;
...
% support of A
\filldraw[pattern=owennortheastsmall,scale=\domainscale] % Support of f
\suppA
%\obstacle
;
...
\draw (-0.5,-2.8) node[fill=white] {$\supp(I-A)$};
\end{tikzpicture}

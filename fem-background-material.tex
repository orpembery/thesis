...
\NLtGI{\thetah}^2 \leq \Cboundaryo \mleft(\En\nvar\mright)^{2\mleft(\floor{\frac{j}2}+1\mright)}\NLiD{n}^4 k^2 h^{2p-1} \Nfn{p-1,h}{\thetah}^2 + \Cboundaryt h \NW{\rho}^2,
\eeq
\ele
...
\NLtGI{\thetah}^2 \leq k \Cmess \mleft(\En\nvar\mright)^{\floor{\frac{j}2}+1}\NLiD{n}^2 h^p \NW{\rho}\Nfn{p-1,h}{\thetah} + \half \CMT^2 \Cfn{0,1} h\NW{\rho}^2 + \half \NLtGI{\thetah}^2
\eeq

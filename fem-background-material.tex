...
To obtain a bound on the error in the weighted $H^1$ norm, we take $\vh = \Ih u$ in \cref{eq:gardingerror}, where $\Ih$ denotes the interpolant if the interpolant is well-defined, or the Scott--Zhang quasi-interpolant \cref{ScZh:90}, so that

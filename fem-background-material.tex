...
From \cref{thm:fembound,lem:bestapprox} we have the following \namecref{cor:fembound}.
\optodo{Propagate through $\Pfn{}$ coming out, it's done in the Coloolary below and theorem above.}
...
&\quad\quad\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\label{eq:ltthetahbound}
\end{align}
\ele
...
\end{align}
\optodo{Part 3 of weighted $\Ph$ bound can surely be improved by doing the standard argument and then just dropping in and out. Possibly part 4 too}
...
&=\Nfn{p-1,h,n}{\thetah}  \Cfourteen \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1}\NLiD{n}^2 h^p \mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright) \NLtD{\thetah} \label{eq:innerprod1}.
\end{align}
\optodo{Derive $\Cc$}
...
&\quad\quad \mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\NLtD{\thetah}\label{eq:innerprod2}
\end{align}
 by \cref{eq:wlt}.
...
&\quad\quad \mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\NLtD{\thetah}\\
...
&\quad\quad \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1}\NLiD{n}^2\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\NLtD{\thetah}\nonumber\\
\end{align*}
...
&+\mleft(  \Cfourteen  + \CMT \CinvVhp \Cfn{0,1}\Cboundaryo^{\half} \mright)k^2h^p\Nfn{p-1,h,n}{\thetah}\Bigg]\nonumber\\
&\quad\quad \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1}\NLiD{n}^2\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\label{eq:part3penultimate},
\end{align}
...
&\quad\quad\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\NW{\rho}\nonumber\\
&+\Csecond  \Chighfn{p-1,1} \mleft(1+\mleft(\En\nvar\mright)^{\half(\floor{\frac{p-1}2}+1)}\NLiD{n}\nmin^{-\frac{p}2}\mright)^{p-1}\mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1}\NLiD{n}^2\nonumber\\
&\quad\quad\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)(hk )^{p+1}+ \CFEMttilde \CAnk h^{2p}k^{2p+1}\mright)\NLtD{\thetah}\label{eq:doublehkdep}
\end{align}
Choosing $h$ according to \cref{eq:hfemcond}, \cref{eq:doublehkdep} simplifies to
\begin{align*}
\NLtD{\thetah} &\leq \mleft(\Cfirst + \Csecond\Chighfn{p-1,2} \nvar^3\NLiD{n}\nmin^{2-p} \mright)\mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1}\NLiD{n}^2\\
&\quad\quad\mleft(\CFEMotilde \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CFEMttilde \CAnk (hk)^p\mright)\NW{\rho} + \half \NLtD{\thetah},
\end{align*}

and therefore it follows that
\beq\label{eq:ltboundwithrho}
\NLtD{\thetah} \leq \nvar^3\NLiD{n}^3\nmin^{2-p} \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1} \mleft(\CLtboundo \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CLtboundt  \CAnk (hk)^p\mright)\NW{\rho}.
\eeq
...
&\mleft.+\CHoboundt \mleft(1+\mleft(\En\nvar\mright)^{\half(\floor{\frac{p-1}2}+1)}\NLiD{n}\nmin^{-\frac{p}2}\mright)\nvar^3\NLiD{n}^3\nmin^{2-p} \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1} \CAnk k(hk)^p\mright]\NW{\rho}.\label{eq:hoboundwithrho}
\end{align}

...
\end{align}
\tohere
THERE'S A BUG IN HERE SOMEWHERE, I'M MISSING A POWER OF $H$ IN THE SECOND TERM
and by combining \cref{eq:sntheta,eq:ltboundwithrho} we obtain (as $hk \leq 1$)
\begin{align*}
\SNHoD{\thetah} &\leq \nvar^3\NLiD{n}^3\nmin^{2-p} \mleft(\En \nvar\mright)^{\floor{\frac{p-1}2}+1} \mleft(\CLtboundo \Pfn{p-2}\mleft(\NLiD{n}\mright)h + \CLtboundt  \CAnk (hk)^p\mright)
\end{align*}
\beqs

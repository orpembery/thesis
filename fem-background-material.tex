...
\beqs
\NLtD{u-\uh} \leq \CFEMLt \mleft(h + (kh)^p\mright) \inf_{\vh \in \Vhp} \NW{u-\vh}, \tand
\eeqs
\beqs
\NW{u-\uh} \leq \CFEMHo \mleft(1 + k(kh)^p\mright) \inf_{\vh \in \Vhp} \NW{u-\vh},
\eeqs
...
\eeqs
\beqs
\CFEMHo = \Cfn{-1,1}\max\set{\CLtboundo+\CHoboundo,\CLtboundt+\CHoboundt}.
\eeqs
\epf

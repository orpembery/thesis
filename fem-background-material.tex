...
\NHmsDn{v} = \sup_{w \in \HsD} \frac{\IPLtDn{v}{w}}{\NHsD{w}}.
\eeq
We put the \emph{standard} $H^s$-norm in the denominator of \cref{eq:negweightnorm} so that we have $\NHmsDn{v} \leq \NLiD{n} \NHmsD{v}.$

...
We now discuss error bounds for finite-element methods for the Helmholtz equation. We  give some intuition behind these bounds, provide a brief history of their development, and briefly constrast them with error bounds for the stationary diffusion equation before a more in-depth discussion of the techniques used to prove quasi-optimality and error bounds for the Helmholtz equation.

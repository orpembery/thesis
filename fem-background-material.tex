...
We will use the following three results numerous times.
...
The following \namecref{lem:intoip} will be used numerous times to bound the inner product of two discrete functions by their negative- and positive-higher-order discrete norms, or to transfer discrete derivatives from one argument of the inner product to the other.
...
The following \namecref{lem:continuity} is straightforward to prove.

...
k^{\tau}\eps^{-2}\mleft(\frac1\alpha \log_s \mleft(\frac{\sqrt{2} \co \Ccoarse^\alpha k^{\sigma-a\alpha}}\eps\mright)+2\mright)^2 + k^{\frac{\gamma\sigma}{\alpha}}\eps^{-2}  & \tif \beta = \gamma,\\ 

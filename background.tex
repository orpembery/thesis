...
\eeqs
\eprob
\optodo{Proof of $H^m$ regularity when $f$ etc. is smooth enough - Grisvard/McClean}
...
\Re\mleft(a(v,v)\mright) \geq \Amin \NW{v}^2 - \mleft(\Amin + \NLiDRRR{n}\mright)\NLtDR{v}^2,
\eeq

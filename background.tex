...
\caption[An example of the sets in the definitions of the Helmholtz Exterior Dirichlet Problem and Truncated Exterior Dirichlet Problem.]{An example of the sets $\Dm,$ $\GD$, $\BR$, {$\Dtilde$}, $D$, and $\GI$ and $\supp f$, $\supp(I-A)$, and $\supp(1-n)$ from \cref{prob:edp,prob:tedp}.}
\end{centering}
\end{figure}

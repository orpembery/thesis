...
\end{subfigure}
\caption{GMRES iteration counts for $\AmatoI\Amatt$ where $\nso=\nst=1$ and $\NLiDRRdtd{\Aso-\Ast} = \alpha$ as described in \cref{sec:num}.}
\end{figure}
...
\end{subfigure}
\caption{GMRES iteration counts for $\AmatoI\Amatt$ where $\Aso=\Ast=1$ and $\NLiDRR{\nso-\nst} = \alpha$ as described in \cref{sec:num}.}
\end{figure}

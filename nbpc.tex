...
%$ to be a good preconditioner for $\Amat^{(2)}$
 ...
 We note that the above suggestion of re-using preconditioners could, at first glance, reduce the computational effort needed because Helmholtz preconditioners typically require more effort to \emph{construct} than they do to \emph{apply}.

...
\cref{thm:GMRES1_intro} has the following \lcnamecref{cor:GMRES_intro} (see, e.g., , and the proofs of \cref{cor:1,cor:1a} follow from combining this with \cref{thm:1}.

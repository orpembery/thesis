...
\caption{Plots of number of GMRES iterations required for convergence for 100 realisations of ... with the standard deviation $=1 $  \label{fig:prob-plot-0.0}}
\end{figure}

\begin{figure}[h]
    \centering
\input{prob-plot-rate-1.0.pgf}
\caption{Plots of number of GMRES iterations required for convergence for 100 realisations of ... with the standard deviation $=1/k $  \label{fig:prob-plot-1.0}}
\end{figure}

\begin{figure}[h]
    \centering
\input{prob-plot-rate-2.0.pgf}
\caption{Plots of number of GMRES iterations required for convergence for 100 realisations of ... with the standard deviation $=1/k^2 $  \label{fig:prob-plot-2.0}}
\end{figure}

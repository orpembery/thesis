...
\input{nbpc-linfinity-plot-n-0.pgf}
    \end{subfigure}
\caption{\label{fig:nbpclinfinity0} $noise \sim 1/k$}
\end{figure}\optodo{Update caption once I've written this}
...
\input{nbpc-linfinity-plot-n-1.pgf}
    \end{subfigure}
\caption{\label{fig:nbpclinfinity1} $noise \sim 1/k^{0.5}$}
\end{figure}\optodo{Update caption once I've written this}
...
\input{nbpc-linfinity-plot-n-2.pgf}
    \end{subfigure}
\caption{\label{fig:nbpclinfinity2} $noise \sim 1$}
\end{figure}\optodo{Update caption once I've written this}

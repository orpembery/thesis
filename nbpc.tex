...
\begin{table}
  ...
  \caption{Results applying our sequential nearby-preconditioning-Quasi-Monte-Carlo algorithm}\label{tab:nbpcqmcseq}
\end{table}\optodo{Make caption better}

\begin{table}
  \centering
  \input{nbpc-qmc-parallel-table}
  \caption{Results applying our parallel nearby-preconditioning-Quasi-Monte-Carlo algorithm}\label{tab:nbpcqmcspar}
  \end{table}\optodo{Make caption better}

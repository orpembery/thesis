...
\item\label[itemreason]{it:notideal1} The condition \cref{eq:nbpcas} must hold almost surely, and
  \item\label[itemreason]{it:notideal2} \Cref{cor:stonbpcas} does not give any explicit information on the distribution of the number of GMRES iterations depends on the distribution of $\NLiDRR{\nso-\nst}.$
    \een

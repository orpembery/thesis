...
\begin{table}
  ...
  \caption{The quantities $\alphaz,$ $\alphao,$ and $\alphao/\alphaz$ for differents QoIs, where the QMC error $Err \approx C \NQMC^{\alphaz - \alphao\log(k)}$.}\label{tab:qmcalpha}
  \end{table}

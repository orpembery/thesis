...
\section[Numerical experiments investigating sharpness]{Numerical experiments investigating the sharpness of \lcnamecrefs{cor:1} \ref{cor:1} and \ref{cor:1a}}\label{sec:num}
